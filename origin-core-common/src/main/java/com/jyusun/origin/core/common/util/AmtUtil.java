...
// * 大写数字
// */
// private static final char[] CN_UPPER_NUMBERS = {'零', '壹', '贰', '叁', '肆', '伍', '陆', '柒',
// '捌', '玖'};
// /**
// * 整数部分的单位
// */
// private static final char[] CN_UPPER_UNIT = {'元', '拾', '佰', '仟', '万', '拾', '佰', '仟',
// '亿', '拾', '佰', '仟', '万', '拾', '佰', '仟'};
// /**
// * 小数部分的单位
// */
...
// return BigDecimal.ZERO.compareTo(amt.remainder(BigDecimal.ONE)) == 0 ? "元整" :
// StringUtil.EMPTY;
// }
//
//
